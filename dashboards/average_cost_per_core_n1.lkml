- name: add_a_unique_name_1673982753
  title: Untitled Visualization
  model: gcp_billing
  explore: gcp_billing_export
  type: looker_column
  fields: [gcp_billing_export.usage_start_month, sum_of_usage_amount_in_pricing_units,
    gcp_billing_export.total_net_cost, gcp_billing_export.total_cost, gcp_billing_export.total_cud_cost,
    gcp_billing_export.total_non_cud_cost, gcp_billing_export.machine_type, gcp_billing_export__credits.total_amount]
  ...
  filters:
    ...
    gcp_billing_export.machine_type: N1
  sorts: [gcp_billing_export.machine_type, gcp_billing_export.usage_start_month desc]
  limit: 500
  column_limit: 50
  total: true
  dynamic_fields:
  - category: table_calculation
    expression: "(${gcp_billing_export.total_non_cud_cost}/${sum_of_usage_amount_in_pricing_units})*24"
